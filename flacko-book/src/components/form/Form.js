...
import { Chip, Paper, Divider, LinearProgress } from '@mui/material';
import imageCompression from 'browser-image-compression';
import Avatar from '@mui/material/Avatar';
import VideocamRoundedIcon from '@mui/icons/VideocamRounded';
import PhotoRoundedIcon from '@mui/icons/PhotoRounded';
import EmojiEmotionsOutlinedIcon from '@mui/icons/EmojiEmotionsOutlined';
